...
public interface Controller {
    ...
    String KCAL_ENABLE = "/sys/kernel/kcal/kcal_enable";
    String KCAL_CONT = "/sys/kernel/kcal/kcal_cont";
    String KCAL_HUE = "/sys/kernel/kcal/kcal_hue";
    String KCAL_MIN = "/sys/kernel/kcal/kcal_min";
    String KCAL_RGB = "/sys/kernel/kcal/kcal";
    String KCAL_SAT = "/sys/kernel/kcal/kcal_sat";
    String KCAL_VAL = "/sys/kernel/kcal/kcal_val";
}
